...
public class IdfXProximityRectangleCell extends AFeature {
	
	int idfIndexLowToHigh;
	int proximityIndexNearToFar;
	double value = Double.MAX_VALUE; 
	
	public IdfXProximityRectangleCell(Config config, int idfIndexLowToHigh, int proximityIndexNearToFar) throws IOException, ClassNotFoundException, ConfigurationException, SecurityException, URISyntaxException, InstantiationException, IllegalAccessException, InvocationTargetException, NoSuchMethodException {
		super(config);
